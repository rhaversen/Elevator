...
public:
    ...
    {}
        ...
        SLATE_ARGUMENT(FVendorSandboxProgram*, Program)
    SLATE_END_ARGS()
...
private:
    ...
    FVendorSandboxProgram* Program = nullptr;
};

/** Program O: Vendor Sandbox - Iowa Gambling / Cambridge Gambling hybrid */
class ELEVATOR_API FVendorSandboxProgram : public FTrialProgramBase
{
