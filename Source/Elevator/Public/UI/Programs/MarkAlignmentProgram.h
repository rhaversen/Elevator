...
public:
    ...
    {}
        ...
        SLATE_ARGUMENT(FMarkAlignmentProgram*, Program)
    SLATE_END_ARGS()
...
private:
    ...
    FMarkAlignmentProgram* Program = nullptr;
};

/** Program K: Mark Alignment - Mental Rotation Test */
class ELEVATOR_API FMarkAlignmentProgram : public FTrialProgramBase
{
    friend class SMarkAlignmentWidget;
public:
    FMarkAlignmentProgram();
protected:
