...
class FDirectoryIndexRebuildProgram;
...
public:
    SLATE_BEGIN_ARGS(SDirectoryIndexRebuildWidget) {}
        SLATE_ARGUMENT(FDirectoryIndexRebuildProgram*, Program)
    SLATE_END_ARGS()
...
private:
    FDirectoryIndexRebuildProgram* Program = nullptr;
};

/** Program Q: Directory Index Rebuild - Rey-Osterrieth Complex Figure Test */
class ELEVATOR_API FDirectoryIndexRebuildProgram : public FTrialProgramBase
{
