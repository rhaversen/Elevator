...
public:
    ...
    {}
        ...
        SLATE_ARGUMENT(FTemplateMatrixProgram*, Program)
    SLATE_END_ARGS()
...
private:
    ...
    FTemplateMatrixProgram* Program = nullptr;
};

/** Program N: Template Matrix - Raven's Progressive Matrices */
class ELEVATOR_API FTemplateMatrixProgram : public FTrialProgramBase
{
    friend class STemplateMatrixWidget;
public:
    FTemplateMatrixProgram();
protected:
