...
public:
    ...
    {}
        ...
        SLATE_ARGUMENT(FProofDiffViewerProgram*, Program)
    SLATE_END_ARGS()
...
private:
    ...
    FProofDiffViewerProgram* Program = nullptr;
};

/** Program J: Proof Diff Viewer - Flicker/Change Blindness Test */
class ELEVATOR_API FProofDiffViewerProgram : public FTrialProgramBase
{
    friend class SProofDiffWidget;
public:
    FProofDiffViewerProgram();
protected:
