...
public:
    ...
    {}
        ...
        SLATE_ARGUMENT(FWorkflowRouterProgram*, Program)
    SLATE_END_ARGS()
...
private:
    ...
    FWorkflowRouterProgram* Program = nullptr;
};

/** Program H: Workflow Router - Trail Making Test (Processing Speed/Flexibility) */
class ELEVATOR_API FWorkflowRouterProgram : public FTrialProgramBase
{
    friend class STrailWidget;
public:
    FWorkflowRouterProgram();
protected:
