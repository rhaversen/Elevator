...
public:
    ...
    {}
        ...
        SLATE_ARGUMENT(FPasatVisualProgram*, Program)
    SLATE_END_ARGS()
...
private:
    ...
    FPasatVisualProgram* Program = nullptr;
};

/** Program M: Budget Ticker - PASAT (Working Memory) */
class ELEVATOR_API FPasatVisualProgram : public FTrialProgramBase
{
