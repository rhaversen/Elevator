...
public:
    SLATE_BEGIN_ARGS(SFollowUpMarkerWidget) {}
        SLATE_ARGUMENT(FNBackTaskProgram*, Program)
    SLATE_END_ARGS()
...
private:
    FNBackTaskProgram* Program = nullptr;
};
 ...
 */
class ELEVATOR_API FNBackTaskProgram : public FTrialProgramBase
{
