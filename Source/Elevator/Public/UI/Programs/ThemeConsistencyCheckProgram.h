...
class FThemeConsistencyCheckProgram;
...
public:
    SLATE_BEGIN_ARGS(SThemeConsistencyCheckWidget) {}
        SLATE_ARGUMENT(FThemeConsistencyCheckProgram*, Program)
    SLATE_END_ARGS()
...
private:
    FThemeConsistencyCheckProgram* Program = nullptr;
};
 ...
 */
class ELEVATOR_API FThemeConsistencyCheckProgram : public FTrialProgramBase
{
