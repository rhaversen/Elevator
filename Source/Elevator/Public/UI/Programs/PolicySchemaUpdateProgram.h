...
class FPolicySchemaUpdateProgram;
...
public:
    ...
    {}
        ...
        SLATE_ARGUMENT(FPolicySchemaUpdateProgram*, Program)
    SLATE_END_ARGS()
...
private:
    ...
    FPolicySchemaUpdateProgram* Program = nullptr;
};

/** Program I: Policy Schema Update - Wisconsin Card Sort Test */
class ELEVATOR_API FPolicySchemaUpdateProgram : public FTrialProgramBase
{
    friend class SPolicyCardWidget;
public:
    FPolicySchemaUpdateProgram();
protected:
