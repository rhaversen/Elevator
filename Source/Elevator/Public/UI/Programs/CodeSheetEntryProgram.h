...
public:
    ...
    {}
        ...
        SLATE_ARGUMENT(FCodeSheetEntryProgram*, Program)
    SLATE_END_ARGS()
...
private:
    ...
    FCodeSheetEntryProgram* Program = nullptr;
};

/** Program L: Code Sheet Entry - Symbol Digit Modalities Test */
class ELEVATOR_API FCodeSheetEntryProgram : public FTrialProgramBase
{
    friend class SCodeSheetWidget;
public:
    FCodeSheetEntryProgram();
protected:
