#include "UI/Programs/CodeSheetEntryProgram.h"
...
// ============================================================================
// FCodeSheetEntryProgram Implementation
// ============================================================================
...
void FCodeSheetEntryProgram::GenerateNewTrial()
{
...
int32 FCodeSheetEntryProgram::GetDigitButtonAtPosition(const FVector2D& LocalPos, const FVector2D& WidgetSize) const
{
...
void FCodeSheetEntryProgram::EnterDigit(int32 Digit)
{
...
void FCodeSheetEntryProgram::InvalidateWidget() const
{
...
TSharedRef<SWidget> FCodeSheetEntryProgram::BuildTrialBody()
{
...
void FCodeSheetEntryProgram::HandlePointerMoved(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FCodeSheetEntryProgram::HandlePointerPressed(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FCodeSheetEntryProgram::HandlePointerReleased(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
