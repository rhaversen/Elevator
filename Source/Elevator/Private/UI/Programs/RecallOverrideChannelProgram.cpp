#include "UI/Programs/RecallOverrideChannelProgram.h"
...
void FRecallOverrideChannelProgram::GenerateNewTrial()
{
...
void FRecallOverrideChannelProgram::OnTrialTimerExpired()
{
    if (bIsStopTrial)
    {
...
bool FRecallOverrideChannelProgram::IsStopSignalVisible() const
{
...
void FRecallOverrideChannelProgram::ClickSend()
{
...
TSharedRef<SWidget> FRecallOverrideChannelProgram::BuildTrialBody()
{
...
TSharedRef<SWidget> FRecallOverrideChannelProgram::BuildTrialFooter()
{
    return SNew(SVerticalBox)
...
void FRecallOverrideChannelProgram::HandlePointerMoved(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FRecallOverrideChannelProgram::HandlePointerPressed(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
    if (bHandledByPreProcessor) return;
...
void FRecallOverrideChannelProgram::HandlePointerReleased(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
