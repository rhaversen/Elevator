#include "UI/Programs/GoNoGoTaskProgram.h"
...
REGISTER_SCREEN_PROGRAM(FGoNoGoTaskProgram, "go_no_go_task")

FGoNoGoTaskProgram::FGoNoGoTaskProgram()
    : FTrialProgramBase(20)  // 20 trials
{
    SetTrialTitle(FText::FromString(TEXT("Go/No-Go Task")));
    GenerateNewTrial();
}

void FGoNoGoTaskProgram::GenerateNewTrial()
{
...
TSharedRef<SWidget> FGoNoGoTaskProgram::BuildTrialBody()
{
...
TSharedRef<SWidget> FGoNoGoTaskProgram::BuildTrialFooter()
{
    return SNew(SVerticalBox)
...
void FGoNoGoTaskProgram::OnTrialTimerExpired()
{
...
FString FGoNoGoTaskProgram::GetCurrentIcon() const
{
...
void FGoNoGoTaskProgram::Approve()
{
...
void FGoNoGoTaskProgram::HandlePointerMoved(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FGoNoGoTaskProgram::HandlePointerPressed(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
    if (bHandledByPreProcessor) return;
...
void FGoNoGoTaskProgram::HandlePointerReleased(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
