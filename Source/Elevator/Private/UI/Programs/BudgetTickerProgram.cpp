#include "UI/Programs/BudgetTickerProgram.h"
...
// ============================================================================
// FBudgetTickerProgram Implementation
// ============================================================================
...
void FBudgetTickerProgram::GenerateNewTrial()
{
...
void FBudgetTickerProgram::AdvanceToNextNumber()
{
    // Simply add a new random number to the array
    NumberHistory.Add(FMath::RandRange(1, 9));
}

int32 FBudgetTickerProgram::GetSumButtonAtPosition(const FVector2D& LocalPos, const FVector2D& WidgetSize) const
{
...
void FBudgetTickerProgram::EnterSum(int32 OptionIndex)
{
...
void FBudgetTickerProgram::InvalidateWidget() const
{
...
TSharedRef<SWidget> FBudgetTickerProgram::BuildTrialBody()
{
...
void FBudgetTickerProgram::HandlePointerMoved(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FBudgetTickerProgram::HandlePointerPressed(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FBudgetTickerProgram::HandlePointerReleased(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
