#include "UI/Programs/WisconsinCardSortingTestProgram.h"
...
REGISTER_SCREEN_PROGRAM(FWisconsinCardSortingTestProgram, "wisconsin_card_sorting_test")
...
// ============================================================================
// FWisconsinCardSortingTestProgram Implementation
// ============================================================================

FWisconsinCardSortingTestProgram::FWisconsinCardSortingTestProgram()
    : FTrialProgramBase(4)  // 4 trials (rule shifts) with longer calibration each
{
    SetTrialTitle(FText::FromString(TEXT("Wisconsin Card Sorting Test")));
...
void FWisconsinCardSortingTestProgram::GenerateNewTrial()
{
    GenerateCard();
}

void FWisconsinCardSortingTestProgram::GenerateCard()
{
...
bool FWisconsinCardSortingTestProgram::IsCorrectPile(int32 PileIndex) const
{
...
int32 FWisconsinCardSortingTestProgram::GetPileAtPosition(const FVector2D& NormalizedPos) const
{
...
void FWisconsinCardSortingTestProgram::DropOnPile(int32 PileIndex)
{
...
void FWisconsinCardSortingTestProgram::ProcessPendingAdvance()
{
...
void FWisconsinCardSortingTestProgram::InvalidateWidget() const
{
...
TSharedRef<SWidget> FWisconsinCardSortingTestProgram::BuildTrialBody()
{
...
void FWisconsinCardSortingTestProgram::HandlePointerMoved(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FWisconsinCardSortingTestProgram::HandlePointerPressed(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
    if (bHandledByPreProcessor || GetTaskComplete()) return;
...
void FWisconsinCardSortingTestProgram::HandlePointerReleased(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
