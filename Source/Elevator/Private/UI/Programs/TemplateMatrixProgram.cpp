#include "UI/Programs/TemplateMatrixProgram.h"
...
// ============================================================================
// FTemplateMatrixProgram Implementation
// ============================================================================
...
void FTemplateMatrixProgram::GenerateNewTrial()
{
    MatrixCells.Empty();
...
void FTemplateMatrixProgram::DrawShape(FSlateWindowElementList& OutDrawElements, int32 LayerId, const FGeometry& Geometry,
...
int32 FTemplateMatrixProgram::GetCandidateAtPosition(const FVector2D& LocalPos, const FVector2D& WidgetSize) const
{
...
void FTemplateMatrixProgram::SelectOption(int32 Index)
{
...
void FTemplateMatrixProgram::InvalidateWidget() const
{
...
TSharedRef<SWidget> FTemplateMatrixProgram::BuildTrialBody()
{
...
void FTemplateMatrixProgram::HandlePointerMoved(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FTemplateMatrixProgram::HandlePointerPressed(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FTemplateMatrixProgram::HandlePointerReleased(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
