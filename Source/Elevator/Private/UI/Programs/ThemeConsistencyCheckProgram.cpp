#include "UI/Programs/ThemeConsistencyCheckProgram.h"
...
TSharedRef<SWidget> FThemeConsistencyCheckProgram::BuildTrialBody()
{
...
void FThemeConsistencyCheckProgram::GenerateNewTrial()
{
...
void FThemeConsistencyCheckProgram::SubmitResponse(bool bIsLeftResponse)
{
...
void FThemeConsistencyCheckProgram::HandlePointerPressed(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FThemeConsistencyCheckProgram::HandlePointerMoved(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
    if (AreAllTrialsComplete()) return;
...
void FThemeConsistencyCheckProgram::HandlePointerReleased(const FScreenPointerEvent& Event, bool bHandledByPreProcessor)
{
...
void FThemeConsistencyCheckProgram::InvalidateWidget() const
{
...
float FThemeConsistencyCheckProgram::GetDragThreshold() const
{
